...
router.get("/", (req, res) => {
  res.json({
    ...
    version: "1.0.0",
    description: "Enhanced API for image listing and comprehensive search",
    endpoints: {
      "GET /api/images": "Get all images from CSV",
      "GET /api/images/search":
        "Enhanced search across all AI-generated tags and attributes",
    ...
    queryParameters: {
      "GET /api/images/search": {
        query: "Search query (required) - searches across all tags",
    ...
    examples: {
      ...
      "Search for glass panels":
        "GET /api/images/search?query=glass panels&limit=5",
      "Get CDN stats": "GET /api/cdn/stats",
      "Check CDN status":
        "GET /api/cdn/check/123?imageUrl=https://example.com/image.jpg",
    },
    features: {
      "Enhanced Search":
        "Searches across all AI-generated tags, materials, colors, features, and attributes",
      "Comprehensive Matching":
        "Matches query words against room types, design themes, materials, colors, objects, and cultural elements",
      "Intelligent Ranking":
        "Ranks results by tag match score and vector similarity",
